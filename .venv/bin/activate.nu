...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/davilos/projects/django2/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('django2-py3.10' == '') {
...
alias deactivate = source '/home/davilos/projects/django2/.venv/bin/deactivate.nu'
